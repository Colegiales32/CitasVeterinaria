...
{acierto && <Acierto mensaje ='Todos los campos son correctos, enviando...' />}

        <form action="" className="bg-white shadow-md rounded-lg py-10 px-5 mb-10" onSubmit={handleSubmit}>
            <div className="mb-5">
                <label className="block text-gray-700 font-bold" htmlFor="mascota">Nombre Mascota</label>
            ...
            <div className="mb-5">
                <label className="block text-gray-700 font-bold" htmlFor="alta">Alta</label>
            ...
            <input type="submit" className="bg-indigo-600 w-full uppercase font-bold p-3 text-white hover:bg-indigo-700 cursor-pointer text-center transition-all"
